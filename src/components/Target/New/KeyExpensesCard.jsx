...
const KeyExpensesCard = () => {
    return (
        <div className="w-[544px] h-[277px] bg-[#212A43] rounded-2xl flex flex-col items-start px-8 py-6 relative">
            <div className="w-[239px] h-[80px] flex flex-col items-start">
                <div className="w-[239px] h-[42px] flex flex-row items-center justify-between">
                    <span className='flex items-center font-baloo text-[24px] font-bold text-[#FFFFFF]'>Key Expenses</span>
                    <span>
                ...
                <div className="w-[190px] h-[32px] flex flex-row items-center">
                    <span className='font-baloo text-[32px] text-[#FFFFFF] font-bold'>23,538,661</span>
                    <div className='flex flex-row items-center ml-2'>
                        <img src={neutral} />
                        <span className='text-[#FFBB0D] font-baloo font-bold text-[14px] flex items-center'>21%</span>
                    </div>
                </div>
            </div>
            <div className="w-[480px] h-[125px] flex flex-col items-center justify-end">
                ...
                <div className="w-[480px] h-[36px] flex flex-row items-center justify-between">
                    ...
                    <div className='flex flex-row items-center'>
                        <img src={neutral} />
                        <span className='font-baloo font-bold text-[12px] text-[#FFBB0D]'>0.5%</span>
                    </div>
                </div>
                <div className="w-[480px] h-[36px] flex flex-row items-center justify-between">
