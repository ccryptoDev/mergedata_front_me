            ...
            <table className="min-w-full text-left text-sm font-light ">
                <thead className="font-medium text-xs leading-[50px] h-12">
                    <tr>
                        ...
                        <th scope="col" className="text-purple-50 text-sm font-bold text center">Year</th>
                        <th scope="col" className="text-purple-50 text-sm font-bold pl-0">Miles</th>
                        <th scope="col" className="text-purple-50 text-sm font-bold text-center pr-0">Color</th>
                            ...
                            data.map((item) => {
                                ...
                                return (
                                    ...
                                    <tr className={`h-[54px] border-b-4 border-neutrals-900 ${((item.id) % 2 === 0) ? 'bg-[#151F39]' : 'bg-neutrals-900'}`} key={item.id}>
                                        ...
                                        <td className="whitespace-nowrap text-neutrals-300 h-12 text-smb text-start">{item.year}</td>
                                        <td className="whitespace-nowrap text-neutrals-300 h-12 text-sm text-start pl-2">{item.miles}</td>
                                        <td className="whitespace-nowrap text-neutrals-300 h-12 text-sm text-center">{item.color}</td>
