        ...
        <div className='w-[196px] h-8 flex flex-col justify-center items-start' >
            <div className='w-[60px] h-[32px] flex justify-between items-center'>
                ...
                <label className='mr-4 w-4 h-4 flex justify-center items-center '>
                    <input type='checkbox' id='CheckBox' value='' onChange={() => setChecked(checked => !checked)} className='checked:bg-[#6043DD] w-4 h-4 bg-[#202449]/0 border-[#C2C8D7] border-[1.5px] rounded focus:ring-0 focus:ring-offset-0' />
                </label>
